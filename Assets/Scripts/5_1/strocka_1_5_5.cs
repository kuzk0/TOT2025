...
public class strocka_1_5_5 : MonoBehaviour
{
    ...
    private void Update()
    {
        {
            float gavno = 0;
            gavno = GetFloat(znach[0].GetComponentInChildren<TEXDraw>().text, 0.0f) - GetFloat(znach[1].GetComponentInChildren<TEXDraw>().text, 0.0f) *
                (GetFloat(znach[2].GetComponentInChildren<TEXDraw>().text, 0.0f) - GetFloat(znach[3].GetComponentInChildren<TEXDraw>().text, 0.0f));
